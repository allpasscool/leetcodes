...
// Runtime: 16 ms, faster than 91.37% of C++ online submissions for Flatten Nested List Iterator.
// Memory Usage: 18.3 MB, less than 60.61% of C++ online submissions for Flatten Nested List Iterator.
